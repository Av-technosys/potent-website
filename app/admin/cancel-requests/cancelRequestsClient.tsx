...
import CancelRequestsTable, { CancelRequestRow } from "./cancelRequestsTable";
...
const CancelRequestsClient = ({ requests, total, currentPage, pageSize }: Props) => {
  ...
  return (
    <div className="w-full p-1">
      <Card>
        <CardHeader>
          <CardTitle>Cancel Request Listing</CardTitle>
          <CardDescription>View order cancellation requests submitted by customers.</CardDescription>
        </CardHeader>
        ...
        <CardContent>
          <div className="w-full max-w-xl">
            <InputGroup className="flex items-center bg-white rounded-full py-2 shadow-none">
              ...
              <InputGroupInput
                ...
                value={searchText}
                type="text"
                placeholder="Search by order, customer, email, or status"
          ...
          <div className="relative">
            ...
            <CancelRequestsTable requests={requests} page={currentPage} pageSize={pageSize} />
          </div>
...
export default CancelRequestsClient;
