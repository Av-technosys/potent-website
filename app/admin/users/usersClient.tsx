...
import UsersTable, { AdminUserRow } from "./usersTable";
...
const UsersClient = ({ users, total, currentPage, pageSize }: Props) => {
    ...
    <div className="w-full p-1">
      <Card>
        <CardHeader>
          ...
          <CardDescription>View registered customers and account details.</CardDescription>
        </CardHeader>
        ...
        <CardContent>
          ...
          <div className="relative">
            ...
            <UsersTable users={users} page={currentPage} pageSize={pageSize} />
          </div>
