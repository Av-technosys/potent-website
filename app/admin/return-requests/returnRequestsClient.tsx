...
import ReturnRequestsTable, { ReturnRequestRow } from "./returnRequestsTable";
...
const ReturnRequestsClient = ({ requests, total, currentPage, pageSize }: Props) => {
  ...
  return (
    <div className="w-full p-1">
      <Card>
        <CardHeader>
          <CardTitle>Return Request Listing</CardTitle>
          <CardDescription>View return requests, product details, reasons, and attached images.</CardDescription>
        </CardHeader>
        ...
        <CardContent>
          <div className="w-full max-w-xl">
            <InputGroup className="flex items-center bg-white rounded-full py-2 shadow-none">
              ...
              <InputGroupInput
                ...
                value={searchText}
                type="text"
                placeholder="Search by customer, product, item, or status"
          ...
          <div className="relative">
            ...
            <ReturnRequestsTable requests={requests} page={currentPage} pageSize={pageSize} />
          </div>
...
export default ReturnRequestsClient;
