...
export default function AddProductForm() {
  ...
  const [productDetails, setProductDetails] = useState<ProductDetailsForm>({
    name: "",
    description: "",
    startingPrice: "",
    banner: null,
  ...
  const handleCreateProduct = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const payload = {
      ...productDetails,
      bannerImage: productDetails.banner?.key,
      highlights: productDetails.highlights.filter(
        (highlight) => highlight.trim().length > 0,
      ),
      hasVarientBox: productDetails.isMixBox,
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    value={productDetails.custimizeBoxInfo}
                    onChange={(e) =>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      type="number"
                      value={productDetails.subscribeMonthlyDiscount}
                      onChange={(e) =>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      type="number"
                      value={productDetails.subscribeBiMontlyDiscount}
                      onChange={(e) =>
                        updateProductDetails(
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      type="number"
                      value={productDetails.cycleSyncDiscount}
                      onChange={(e) =>
                        updateProductDetails(
                          "cycleSyncDiscount",
                          Number(e.target.value),
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      type="number"
                      value={productDetails.maxQuantityPurchase}
                      onChange={(e) =>
                        updateProductDetails(
                          "maxQuantityPurchase",
                          Number(e.target.value),
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      type="number"
                      value={productDetails.freeShippingOver}
                      onChange={(e) =>
                        updateProductDetails(
                          "freeShippingOver",
                          Number(e.target.value),
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-center justify-between rounded-xl border p-4">
                    <Label>Mix Box</Label>
                    <Switch
                      checked={productDetails.isMixBox}
                      onCheckedChange={(checked) =>
                      ...
                      <div key={index} className="flex gap-2">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            updateProductDetails(
                              "highlights",
                              productDetails.highlights.filter(
                                (_, i) => i !== index,
                              ),
                            )
                          }
                ...
                <div className="space-y-3">
                  ...
                  >
                    {!productDetails.banner ? (
                      ...
                      <Image
                        src={getImageUrl(productDetails.banner.preview)}
