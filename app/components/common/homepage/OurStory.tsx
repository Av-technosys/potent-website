        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="flex flex-col text-left lg:col-span-7">
            ...
            <div className="mb-8 grid grid-cols-1 gap-3.5 sm:grid-cols-3">
              <div className="flex flex-col justify-start rounded-2xl border border-[#BDE3EA] bg-[#E6F4F6] p-4">
                <span className="mb-1 block font-serif text-lg font-bold text-[#016271] sm:text-xl">
                  12 hrs
                </span>
            ...
            <div className="mb-4 flex flex-wrap items-center gap-3">
              <Link
                ...
                className="flex cursor-pointer items-center gap-1.5 rounded-full bg-[#016271] px-5 py-2.5 text-xs font-semibold text-white shadow-md transition-all hover:scale-105 hover:bg-[#014e5a] sm:px-6 sm:py-3 sm:text-sm"
              >
              ...
              <Link
                ...
                className="cursor-pointer rounded-full border border-[#016271] px-5 py-2.5 text-xs font-semibold text-[#016271] shadow-2xs transition-all hover:bg-[#016271] hover:text-white sm:px-6 sm:py-3 sm:text-sm"
              >
                Find my size
              </Link>
              ...
              <button
                ...
                disabled={adding}
                className={`flex cursor-pointer items-center gap-1.5 rounded-full px-5 py-2.5 text-xs font-semibold shadow-md transition-all sm:px-6 sm:py-3 sm:text-sm ${
                  added
